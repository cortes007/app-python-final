...
class VistaRegistroCompra:
    def __init__(self, controlador):
        self.controlador = controlador
        self.ventana = tk.Tk()
        self.ventana.title("Registro de Compra")
        self.ventana.resizable(0, 0)
        self.ventana.geometry("400x400")
        self.frame = ttk.Frame(self.ventana)
        self.frame.pack(padx=10, pady=10)
        self.label_title = ttk.Label(self.frame, text="Registrar Compra")
        ...
        self.boton_guardar = ttk.Button(self.frame, text="Guardar", command=self.controlador.validar_datos_compra)
