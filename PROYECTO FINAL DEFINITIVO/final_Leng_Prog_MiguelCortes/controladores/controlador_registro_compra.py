...
from vistas.vista_registro_compra import VistaRegistroCompra
from modelos.base_datos import guardar_nueva_compra

class ControladorRegistroCompra:
    ...
    def abrir_registro_compra(self):
        ...
        self.controlador_menu.ventana_actual = VistaRegistroCompra(self)
        self.controlador_menu.ventana_actual.ventana.mainloop()

    def validar_datos_compra(self):
        ...
        if (nom_producto and cantidad and precio and len(nom_producto) >= 3 and nom_producto.replace(' ', '').isalpha()
            ...
            try:
                guardar_nueva_compra(nom_producto, cantidad, precio, fecha_actual)
